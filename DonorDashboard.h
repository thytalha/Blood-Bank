...
// ================================================================
//
//  Z-ORDER (mirrors AdminDashboard v3 exactly)
//  ─────────────────────────────────────────────────────────────
...
//  ─────────────────────────────────────────────────────────────
//  dgvHistory lives inside pnlGridBox (Dock::Fill, Padding(32,0,32,32)).
//  pnlHistory->AutoScroll = false.
//  dgvHistory->Dock = Fill → stretches to fill the padded box.
