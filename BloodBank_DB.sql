...
BEGIN
    CREATE TABLE BloodRequests (
        ...
        RecipientID INT NOT NULL,                     -- UPDATED: Changed from UserID to RecipientID
        BloodGroup VARCHAR(3) NOT NULL,
        QuantityRequested INT NOT NULL,
        RequestStatus VARCHAR(20) NOT NULL,
        RequestDate DATETIME NOT NULL DEFAULT GETDATE(),
        FOREIGN KEY (RecipientID) REFERENCES Users(UserID) -- UPDATED Foreign Key
    );
END
GO
...
BEGIN
    CREATE TABLE Donations (
        ...
        DonorID INT NOT NULL,                         -- UPDATED: Changed from UserID to DonorID
        BloodGroup VARCHAR(3) NOT NULL,
        Quantity INT NOT NULL,                        -- UPDATED: Changed from QuantityUnits to Quantity
        DonationDate DATETIME NOT NULL DEFAULT GETDATE(),
        ExpiryDate DATE NOT NULL,
        FOREIGN KEY (DonorID) REFERENCES Users(UserID)     -- UPDATED Foreign Key
    );
END
GO
